...
public class SetupOrcPrefab
{
    public static void Execute()
    {
        ...
        if (fbxPrefab != null)
        {
            ...
            // The prompt says "Scale it so it matches the game's scale — try (0.5, 0.5, 0.5) to start since enemies were scaled to half size."
            // But wait, the root prefab was already scaled to 0.5. If we scale the child to 0.5, it will be 0.25 overall.
            // Let's set it to (1, 1, 1) first, or (0.5, 0.5, 0.5) as requested.
